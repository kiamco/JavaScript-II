...
console.log("\n----------------------------------------------------");
console.log("This is the fullname array: ");
console.log(fullName);

// ==== Challenge 2: Use .map() ====
// The event director needs to have all the runner's first names converted to uppercase because the director BECAME DRUNK WITH POWER. Convert each first name into all caps and log the result
let allCaps = [];
allCaps = runners.map(el => el.first_name.toUpperCase());

console.log("\n----------------------------------------------------");
console.log('\n Array with allcaps firstname: ')
console.log(allCaps);
...
console.log("\n----------------------------------------------------");
console.log("\nPeople with large shirts: ")
console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
let ticketPriceTotal = [];
ticketPriceTotal = runners.reduce((acc, val) => ticketPriceTotal = acc + val.donation, 0);

console.log("\n----------------------------------------------------");
console.log("\nThis is the total number of donations: ");
console.log(ticketPriceTotal);

// ==== Challenge 5: Be Creative ====
// Now that you have used .forEach(), .map(), .filter(), and .reduce().  I want you to think of potential problems you could solve given the data set and the 5k fun run theme.  Try to create and then solve 3 unique problems using one or many of the array methods listed above.
console.log("\n----------------------------------------------------");
console.log("Beginning of stretch\n");
// Problem 1 - filet highest donors

let vip = runners.filter(el => el.donation > 250);

console.log("\n----------------------------------------------------");
console.log(" Informations of runners who donated the highest");
console.log(vip);

// Problem 2 - create a new array with object with only names and emails
console.log("\n----------------------------------------------------");
console.log("Email list");

let emailList = [];
runners.forEach((el) => {
    return emailList.push(el.first_name + " " + el.last_name + " " + el.email);
});
